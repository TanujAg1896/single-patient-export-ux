...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-button hover:bg-primary-dark hover:shadow-lg transform hover:-translate-y-0.5",
        destructive:
        ...
        medical: "bg-gradient-primary text-primary-foreground shadow-button hover:shadow-lg transform hover:-translate-y-0.5 hover:bg-primary-dark",
